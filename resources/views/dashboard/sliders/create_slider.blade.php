...
<div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="link" class="form-control" placeholder="  " value="{{old('link')}}" name="link">
                                                        @error("link")
                                                        <span class="text-danger">{{$message}}</span>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> صوره رفع </h4>
                                                <div class="form-group">
                                                    <div id="dpz-multiple-files" class="dropzone dropzone-area">
                                                        <div class="dz-message">يمكنك رفع صوره هنا</div>
                                                    </div>
                                                    <br><br>
                                                </div>
