...
<nav
    ...
    <div class="navbar-wrapper" style="background-color: #2c303b;">
        <div class="navbar-header" style="background-color: #2c303b;" >
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item" >
                    <a class="navbar-brand" href="index.html">
                        <img   alt=" admin logo" width="120px"
                             src="{{asset('images/logo.png')}}">
                        <h4 class="brand-text" style="color:#FFF"> Admin panel</h4>
                    </a>
                </li>
...
@php $locale = session()->get('locale'); @endphp
       ...
       <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
       <span class="mr-1">
                  <span class="user-name text-bold-700"> {{session()->get('locale')}} {{--App::getLocale()--}}
        ...
        @switch($locale)
            ...
            @break
            @case('fr')
            <img src="{{asset('images/flag/ar.png')}}" width="25px"> Arabic
            @break
            @default
            <img src="{{asset('images/flag/ar.png')}}" width="25px"> Arabic
        @endswitch
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                                  <a class="dropdown-item" rel="alternate" hreflang="{{ route('admin.lang.switch', 'ar') }}"
                                   href="{{url('admin/lang/ar')}}">
                                   AR
                                </a>
                                <a class="dropdown-item" rel="alternate" hreflang="{{ route('admin.lang.switch', 'en') }}"
                  ...
                  now=  {{ LaravelLocalization::getCurrentLocaleNative() }}
                  {{ LaravelLocalization::getCurrentLocaleDirection() }}
                  <br>app={{app()->getLocale()}}
