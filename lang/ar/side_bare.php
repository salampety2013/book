<?php
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used during side bar for various
    | 
    |
    */
...
return [
  ...
  'dashboard' => 'لوجة التحكم',
  'manage_users' => 'إعدادات الاعضاء',
  'user_list' => "عرض الاعضاء",
